  ...
  return (
    <nav className="max-w-7xl mx-auto flex items-center justify-between h-16 px-6 py-10  ">
      ...
      <div className="hidden md:flex space-x-6">
        ...
        <a href="/explore" className="flex items-center text-lg font-medium hover:text-gray-400">
          Menu
        </a>
      ...
      <div className="hidden md:flex space-x-4 ">
        <Button   asChild>
          <a href="/order-online"><Bike className="w-5 h-5 mr-2"/>Order Online</a>
        </Button>
        <Button asChild>
        ...
        <Button   asChild>
          <a href="/order-online">Reservation</a>
        </Button>
      </div>
  ...
  <TiThMenu  style={{ width: "30px", height: "30px" }}/> {/* This should set the icon size to 36px */}
          ...
          <SheetContent side="left" className="bg-[#001100] text-white w-64">
            ...
            <div className="flex flex-col mt-4 space-y-4">
              ...
              <a href="/order-online" className="flex items-center text-lg font-medium hover:text-gray-400">
                Order Online
              </a>
              <a href="/cart" className="flex items-center text-lg font-medium hover:text-gray-400">
                <ShoppingBag className="w-5 h-5 mr-2" />
                Cart
              </a>
            </div>
